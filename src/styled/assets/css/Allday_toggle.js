...
export const Allday_toggleDiv = styled.div`
    .theme-switch {
        --toggle-size: 20px;
     ...
     so you can choose any size */
        ...
        --container-radius: 125px;
        /* radius 0 - minecraft mode :) */
        --container-light-bg: #3d7eae;
        --container-night-bg: #1d1f2c;
        --circle-container-diameter: 35px;
        --sun-moon-diameter: 22px;
        --sun-bg: #ecca2f;
        --moon-bg: #c4c9d1;
        --spot-color: #959db1;
        ...
        --transition: 1.5s cubic-bezier(0, -0.02, 0.4, 1.25);
        --circle-transition: 1.5s cubic-bezier(0, -0.02, 0.35, 1.17);
    }
